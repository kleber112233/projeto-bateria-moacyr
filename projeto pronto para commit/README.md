...
Usamos uma assistente de IA (Claude) para organizar a especificação e para corrigir e escrever parte do código, sempre partindo do material da disciplina e do projeto de referência do professor. O grupo revisou tudo e cada integrante precisa saber explicar qualquer trecho.
